...
const createKillsTable: Migration = {
  ...
  run: async (transaction) => {
    await transaction.schema
      ...
      .addColumn('killer_side', 'integer', (col) => col.defaultTo(null))
      ...
      .addColumn('assister_side', 'integer', (col) => col.defaultTo(null))
      ...
      .addColumn('killer_x', 'real', (col) => col.notNull())
      .addColumn('killer_y', 'real', (col) => col.notNull())
      .addColumn('killer_z', 'real', (col) => col.notNull())
      .addColumn('is_killer_airborne', 'boolean', (col) => col.notNull())
      .addColumn('is_killer_blinded', 'boolean', (col) => col.notNull())
      .addColumn('victim_x', 'real', (col) => col.notNull())
      .addColumn('victim_y', 'real', (col) => col.notNull())
      .addColumn('victim_z', 'real', (col) => col.notNull())
      ...
      .addColumn('assister_x', 'real', (col) => col.notNull())
      .addColumn('assister_y', 'real', (col) => col.notNull())
      .addColumn('assister_z', 'real', (col) => col.notNull())
      ...
      .addColumn('distance', 'real', (col) => col.notNull())
      .execute();
  },
};
